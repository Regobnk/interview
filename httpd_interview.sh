...
#Configure firewall for only port 80/443
...
#Configuring logrotate for error logs
...
sudo systemctl enaable rsyncd

#Install NTP using chrony
...
#Install WordPress, transfer files with rsync and make new directory for upload
